...
dot_names=st.text_area('The names you can select on the MA plot',value='None')
...
font_name=st.text_area('The name of the fonts, Arial or Arial Black',value='Arial Black')
...
if st.button('Determine Differential analysis'):
    ...
    fig.update_xaxes(type="log",showgrid=False,
                    ticks="outside", tickvals=[0,1,10, 100, 1000, 10000,100000],
